...
/**
 * JUnit test for version 3 -- SmarterSequential
 ...
 * @version 03/11/13
 */
public class TestSmarterSequential {
	private static final int TIMEOUT = 2000;
	public SmarterSequential ss;
	...
	public void setUp() throws Exception {
		...
		ss = new SmarterSequential(cd, 5, 5);
		ss.buildGrid();
	}
	...
	public void testBuildGrid() {
		...
		assertArrayEquals(expected, ss.grid);
	}
