...
/**
 * JUnit test for version 5 -- SmarterLockBased
 ...
 * @version 03/12/13
 */
public class TestSmarterLockBased {
	...
	public void setUp() throws Exception {
		...
		sl = new SmarterLockBased(cd, 5, 5);
		sl.buildGrid();
	}
	...
	public void testPopulationInGridForSingleGrid2() {
		...
		int[] actual = sl.populationInGrid(3, 3, 3, 3);
		assertArrayEquals(expected, actual);
	}
	...
	public void testPopulationInGridForOneRow() {
		...
		int[] actual = sl.populationInGrid(2, 1, 2, 5);
		assertArrayEquals(expected, actual);
	}
	...
	public void testPopulationInGridForOneColumn() {
		...
		int[] actual = sl.populationInGrid(1, 4, 5, 4);
		assertArrayEquals(expected, actual);
	}
	...
	public void testPopulationInGridWithInvliadInput() {
		int[] expected = new int[]{260, 1100};
		int[] actual = sl.populationInGrid(1, 4, 5, 6);
		assertArrayEquals(expected, actual);
	}
}